...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_6x7(
        ...
        _______, KC_WH_U, KC_HOME, KC_UP  , KC_END , KC_PGUP, LCTL(KC_C),                 KC_PPLS, KC_PMNS, KC_P7  , KC_P8  , KC_P9  , _______,  _______,
        _______, KC_WH_D, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, LCTL(KC_V),                 KC_PSLS, KC_PAST, KC_P4  , KC_P5  , KC_P6  , KC_PENT,  _______,
        CUT    , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   ,                                   KC_PEQL, KC_P1  , KC_P2  , KC_P3  , _______,  _______,
        PASTENF, _______, KC_MPRV, KC_MNXT, KC_MPLY,                                                     KC_P0  , KC_PDOT, _______, _______,  _______,
